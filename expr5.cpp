...
c_compiler::var* c_compiler::expr::logic(bool ANDAND, seq* s, var* z)
{
  using namespace std;
  decl::check(z);
  auto_ptr<seq> sweeper(s);
  int n = s->m_point;
  var* y = s->m_var;
  return y->logic1(ANDAND,n,z);
}

c_compiler::var* c_compiler::var::logic1(bool ANDAND, int n, var* expr)
{
  using namespace std;
  vector<tac*> tmp;
...
c_compiler::var* c_compiler::var::logic2(bool ANDAND, const type* Ty)
{
  var* z = rvalue();
  z = z->promotion();
  const type* Tz = z->m_type;
...
namespace c_compiler {
  template<> var* constant<char>::logic1(bool ANDAND, int n, var* z)
  { return constant_impl::logic1(ANDAND,n,this,z); }
  template<> var* constant<char>::logic2(bool, const type*)
  {
    return zero() ? integer::create(0) : integer::create(1);
  }
  
  template<> var* constant<signed char>::logic1(bool ANDAND, int n, var* z)
  { return constant_impl::logic1(ANDAND,n,this,z); }
  template<> var* constant<signed char>::logic2(bool, const type*)
  {
    return zero() ? integer::create(0) : integer::create(1);
  }
  
  template<> var* constant<unsigned char>::logic1(bool ANDAND, int n, var* z)
  { return constant_impl::logic1(ANDAND,n,this,z); }
  template<> var* constant<unsigned char>::logic2(bool, const type*)
  {
    return zero() ? integer::create(0) : integer::create(1);
  }
  
  template<> var* constant<short int>::logic1(bool ANDAND, int n, var* z)
  { return constant_impl::logic1(ANDAND,n,this,z); }
  template<> var* constant<short int>::logic2(bool, const type*)
  {
    return zero() ? integer::create(0) : integer::create(1);
  }
  
  template<> var* constant<unsigned short int>::logic1(bool ANDAND, int n, var* z)
  { return constant_impl::logic1(ANDAND,n,this,z); }
  template<> var* constant<unsigned short int>::logic2(bool, const type*)
  {
    return zero() ? integer::create(0) : integer::create(1);
  }
...
c_compiler::var* c_compiler::constant<float>::logic1(bool ANDAND, int n, var* z)
{ return constant_impl::logic1(ANDAND,n,this,z); }
c_compiler::var* c_compiler::constant<float>::logic2(bool, const type*)
{
  return zero() ? integer::create(0) : integer::create(1);
}

c_compiler::var* c_compiler::constant<double>::logic1(bool ANDAND, int n, var* z)
{ return constant_impl::logic1(ANDAND,n,this,z); }
c_compiler::var* c_compiler::constant<double>::logic2(bool, const type*)
{
  return zero() ? integer::create(0) : integer::create(1);
}

c_compiler::var* c_compiler::constant<long double>::logic1(bool ANDAND, int n, var* z)
{ return constant_impl::logic1(ANDAND,n,this,z); }
c_compiler::var* c_compiler::constant<long double>::logic2(bool, const type*)
{
  return zero() ? integer::create(0) : integer::create(1);
}

c_compiler::var* c_compiler::constant<void*>::logic1(bool ANDAND, int n, var* z)
{ return constant_impl::logic1(ANDAND,n,this,z); }
c_compiler::var* c_compiler::constant<void*>::logic2(bool, const type*)
{
  return zero() ? integer::create(0) : integer::create(1);
}

c_compiler::var* c_compiler::expr::cond(seq* seq1, seq* seq2, var* expr3)
{
  using namespace std;
  auto_ptr<seq> sweeper1(seq1);
  auto_ptr<seq> sweeper2(seq2);
  var* expr1 = seq1->m_var;
  var* expr2 = seq2->m_var;
  int n = seq1->m_point;
  int m = seq2->m_point;
  return expr1->cond(n,m,expr2,expr3);
}

namespace c_compiler { namespace cond_impl {
  const type* valid(var*, var*);
} } // end of namespace cond_impl and c_compiler

const c_compiler::type*
c_compiler::cond_impl::valid(var* expr2, var* expr3)
{
  using namespace std;
  ...
  if ( T2->arithmetic() && T3->arithmetic() ){
    ...
    struct sweeper {
      int n;
      sweeper() : n(c_compiler::code.size()) {}
      ~sweeper()
      {
        using namespace std;
...
c_compiler::var* c_compiler::var::cond(int n, int m, var* expr2, var* expr3)
...
namespace c_compiler {
  template<> var* constant<char>::cond(int n, int m, var* expr2, var* expr3)
  { return constant_impl::cond(this,n,expr2,m,expr3); }
  
  template<> var* constant<signed char>::cond(int n, int m, var* expr2, var* expr3)
  { return constant_impl::cond(this,n,expr2,m,expr3); }
  
  template<> var* constant<unsigned char>::cond(int n, int m, var* expr2, var* expr3)
  { return constant_impl::cond(this,n,expr2,m,expr3); }
  
  template<> var* constant<short int>::cond(int n, int m, var* expr2, var* expr3)
  { return constant_impl::cond(this,n,expr2,m,expr3); }
...
c_compiler::var* c_compiler::constant<float>::cond(int n, int m, var* expr2, var* expr3)
{ return constant_impl::cond(this,n,expr2,m,expr3); }

c_compiler::var* c_compiler::constant<double>::cond(int n, int m, var* expr2, var* expr3)
{ return constant_impl::cond(this,n,expr2,m,expr3); }

c_compiler::var* c_compiler::constant<long double>::cond(int n, int m, var* expr2, var* expr3)
{ return constant_impl::cond(this,n,expr2,m,expr3); }

c_compiler::var* c_compiler::constant<void*>::cond(int n, int m, var* expr2, var* expr3)
{ return constant_impl::cond(this,n,expr2,m,expr3); }

c_compiler::var* c_compiler::var01::cond(int y, int x, var* expr2, var* expr3)
{
  using namespace std;
  if ( scope::current->m_id == scope::BLOCK )
    sweep();
